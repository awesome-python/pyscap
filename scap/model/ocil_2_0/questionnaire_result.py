...
class questionnaire_result(Model):
    def __init__(self):
        super(questionnaire_result, self).__init__()
    ...
    def parse_attribute(self, name, value):
        if name == 'questionnaire_ref':
            ...
            return super(questionnaire_result, self).parse_attribute(name, value)
        return True
    ...
    def parse_sub_el(self, sub_el):
        if sub_el.tag == '{http://scap.nist.gov/schema/ocil/2.0}artifact_results':
            ...
            return super(questionnaire_result, self).parse_sub_el(sub_el)
        return True
