...
class textfilecontent_object(Object)
    def __init__(self):
        super(textfilecontent_object, self).__init__()    # {http://oval.mitre.org/XMLSchema/oval-definitions-5#independent}textfilecontent_object
