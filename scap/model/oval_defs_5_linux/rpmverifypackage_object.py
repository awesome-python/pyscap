...
class rpmverifypackage_object(Object)
    def __init__(self):
        super(rpmverifypackage_object, self).__init__()    # {http://oval.mitre.org/XMLSchema/oval-definitions-5#linux}rpmverifypackage_object
