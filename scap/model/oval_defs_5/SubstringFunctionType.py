...
class SubstringFunctionType(Function):
    def __init__(self):
        super(SubstringFunctionType, self).__init__()    # {http://oval.mitre.org/XMLSchema/oval-definitions-5}substring
    ...
    def parse_attribute(self, name, value):
        if name == 'substring_start':
            ...
            return super(SubstringFunctionType, self).parse_attribute(name, value)
        return True
