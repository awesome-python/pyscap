...
class OVALDefintionsType(Model):
    ...
    TAG_MAP.update(scap.model.oval_defs_5_independent.TAG_MAP)

    import scap.model.oval_defs_5_linux
    TAG_MAP.update(scap.model.oval_defs_5_linux.TAG_MAP)

    import scap.model.oval_defs_5_windows
    TAG_MAP.update(scap.model.oval_defs_5_windows.TAG_MAP)

    def __init__(self):
        super(OVALDefintionsType, self).__init__()    # {http://oval.mitre.org/XMLSchema/oval-definitions-5}oval_definitions
