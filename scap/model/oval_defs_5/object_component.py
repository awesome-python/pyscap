...
class object_component(Component):
    def __init__(self):
        super(object_component, self).__init__()    # {http://oval.mitre.org/XMLSchema/oval-definitions-5}object_component
    ...
    def parse_attribute(self, name, value):
        if name == 'object_ref':
            ...
            return super(object_component, self).parse_attribute(name, value)
        return True
