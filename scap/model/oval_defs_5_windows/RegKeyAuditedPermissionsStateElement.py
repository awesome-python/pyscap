...
class RegKeyAuditedPermissionsStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': {
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}hive': {'class': 'oval_defs_5.EntityStateStringType'},
            ...
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}key_query_value': {'class': 'oval_defs_5.EntityStateStringType'},
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}key_set_value': {'class': 'oval_defs_5.EntityStateStringType'},
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}key_create_sub_key': {'class': 'oval_defs_5.EntityStateStringType'},
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}key_enumerate_sub_keys': {'class': 'oval_defs_5.EntityStateStringType'},
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}key_notify': {'class': 'oval_defs_5.EntityStateStringType'},
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}key_create_link': {'class': 'oval_defs_5.EntityStateStringType'},
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}key_wow64_64key': {'class': 'oval_defs_5.EntityStateStringType'},
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}key_wow64_32key': {'class': 'oval_defs_5.EntityStateStringType'},
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}key_wow64_res': {'class': 'oval_defs_5.EntityStateStringType'},
