...
class regkeyeffectiverights_state(State)
    def __init__(self):
        super(regkeyeffectiverights_state, self).__init__()    # {http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}regkeyeffectiverights_state
