...
class auditeventpolicy_state(State):
    def __init__(self):
        super(auditeventpolicy_state, self).__init__()    # {http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}auditeventpolicy_state
