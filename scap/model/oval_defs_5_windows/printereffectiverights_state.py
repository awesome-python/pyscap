...
class printereffectiverights_state(State)
    def __init__(self):
        ...
        self.ignore_sub_elements.extend([
            ...
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}printer_access_administer',
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}printer_access_use',
