...
class PrinterEffectiveRightsStateElement(StateType):
    MODEL_MAP = {
        ...
        'elements': {
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}printer_name': {'class': 'oval_defs_5.EntityStateStringType'},
            ...
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}printer_access_administer': {'class': 'oval_defs_5.EntityStateStringType'},
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}printer_access_use': {'class': 'oval_defs_5.EntityStateStringType'},
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}job_access_administer': {'class': 'oval_defs_5.EntityStateStringType'},
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}job_access_read': {'class': 'oval_defs_5.EntityStateStringType'},
        }
    }
