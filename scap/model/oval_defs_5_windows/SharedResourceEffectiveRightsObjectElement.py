...
class SharedResourceEffectiveRightsObjectElement(ObjectType):
    MODEL_MAP = {
        ...
        'elements': {
            ...
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}behaviors': {'class': 'SharedResourceEffectiveRightsBehaviors', 'min': 0},
