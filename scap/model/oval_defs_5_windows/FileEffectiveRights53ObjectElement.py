...
class FileEffectiveRights53ObjectElement(ObjectType):
    MODEL_MAP = {
        'xml_namespace': 'http://oval.mitre.org/XMLSchema/oval-definitions-5#windows',
        'tag_name': 'fileeffectiverights53_object',
        'elements': {
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5}set': {'class': 'oval_defs_5.SetElement'},
            '{http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}behaviors': {'class': 'FileEffectiveRights53Behaviors', 'min': 0},
