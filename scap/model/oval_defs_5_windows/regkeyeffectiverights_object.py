...
class regkeyeffectiverights_object(Object)
    def __init__(self):
        super(regkeyeffectiverights_object, self).__init__()    # {http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}regkeyeffectiverights_object
