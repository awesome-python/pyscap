...
class fileeffectiverights53_object(Object)
    def __init__(self):
        super(fileeffectiverights53_object, self).__init__()    # {http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}fileeffectiverights53_object
