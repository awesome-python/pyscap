...
class activedirectory57_state(State):
    def __init__(self):
        super(activedirectory57_state, self).__init__()    # {http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}activedirectory57_state
