...
class regkeyauditedpermissions53_object(Object)
    def __init__(self):
        super(regkeyauditedpermissions53_object, self).__init__()    # {http://oval.mitre.org/XMLSchema/oval-definitions-5#windows}regkeyauditedpermissions53_object
