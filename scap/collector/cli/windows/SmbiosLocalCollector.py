...
class SmbiosLocalCollector(WindowsCollector):
    ...
    def collect(self):
        ...
        bios_size = ctypes.windll.kernel32.GetSystemFirmwareTable(ctypes.wintypes.DWORD(SmbiosLocalCollector.RSMB), 0, 0, 0)
        ...
        ret = ctypes.windll.kernel32.GetSystemFirmwareTable(ctypes.wintypes.DWORD(SmbiosLocalCollector.RSMB), 0, buf, bios_size)
        ...
        while 1:
            ...
            if type_ in SmbiosLocalCollector.STRUCTURE_TYPES:
                pass
                #logger.debug(SmbiosLocalCollector.STRUCTURE_TYPES[type_] + ' structure')
            else:
